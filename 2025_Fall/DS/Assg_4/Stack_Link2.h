#ifndef DATA_STRUCTURES_STACK_LINK2_H
#define DATA_STRUCTURES_STACK_LINK2_H
#include <stdlib.h>
#include <stdbool.h>
#include <stdio.h>
///////////////////////////////////////////////////////////
...
static inline void Push(Stack *pStack,Element item)//스택이 다 차지 않았다면, item에 해당하는 data를 추가해라.
{
...
#endif //DATA_STRUCTURES_STACK_LINK2_H