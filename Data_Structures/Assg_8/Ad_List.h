#ifndef ASSG_8_AD_LINK_H
#define ASSG_8_AD_LINK_H

//Direc Graph 입력 받으므로 이를 기억할 것.

#include <stdio.h>
#include <string.h>
#include <stdlib.h>
//void 포인터 활용해서 제너릭 코딩 활용해 볼 것.
...
static inline void AddEdge_list(const Graph_list* pGraph_list,const void* start_data,const void* end_data)//기존 vtx 순회하면서 엣지 이어줘야 함.
{
